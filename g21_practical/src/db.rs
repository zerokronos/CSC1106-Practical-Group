...
pub async fn init_db() -> Pool<Sqlite> {
    ...
    sqlx::query("INSERT INTO projectRecords (id, user_id, projectName, projectDescription) VALUES (?, ?, ?, ?)")
    ...
    // Insert a bug report
    sqlx::query("INSERT INTO bugsReports (id, project_id, title, description, reported_by, severity, is_fixed) VALUES (?, ?, ?, ?, ?, ?, ?)")
